...
There are many possible "challenge" word lists to test the WordleR algorithm against, including the original Wordle "Magic Words" list (2315 words), Knuth (5757 words) and Kaggle (over 39k). 
...
short_list.df <- readRDS("Knuth_noplurals_01Jan2025.Rds") # Knuth words, with noun plurals removed
wordsource <- "Knuth"
# short_list.df <- anti_join(short_list.df, used_words.df, by="word")

#short_list.df <- readRDS("short_list.df.kaggle.Rds") # Pre-cook in WordleR
#short_list.df <- readRDS("wordlebot_words.Rds") # Pre-cook in WordleR
...
trial_words <- c("neato", "recap", "fetus", "flake",
                 "lyric", "ovary", "salvo", "stork")
# 'neato' test
#trial_words <- c("neato", "recap")
...
#    subtitle = "Wordle Challenge Words Found in Six Moves or Less vs Starter Words",
    caption = paste0("Wordle challenge words found in six iterations or less\n
                     Tested against a ",words,"-word subset of the ",wordsource," five-letter word list\n
...
#  subtitle = "Testing favorite Wordle starter words (including Horstmeyer and YouTuber) ",
  ...
  caption = paste0("Tested against a ",words,"-word subset of ",wordsource," five-letter word list\nVisit WordleR at: http://bit.ly/WordleR"))
...
#  subtitle = "Testing favorite Wordle starter words (including Horstmeyer and YouTuber) ",
  subtitle = paste0("Testing ", length(trial_words)," winning Wordle starter words"),
  #caption = paste0("Tested against a ",words,"-word subset of Wordle 'Magic Words' list\nVisit WordleR at: http://bit.ly/WordleR")) +
  caption = paste0("Tested against a ",words,"-word subset of the ",wordsource," five-letter word list\nVisit WordleR at: http://bit.ly/WordleR")) +
  geom_vline(xintercept = 6)

ggsave(plot=p3,filename = "comparing_starter_words_iterations_line.png")
ggsave(plot=p3,filename = "www/BestWordleRWords.png")
