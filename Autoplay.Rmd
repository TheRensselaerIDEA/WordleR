...
short_list.df <- readRDS("Wordle_Words.Rds") # DEFAULT: "Official" Wordle Magic Words, by letter freq (truncated 18 Oct 2022)
...
letter_freq <- readRDS("letter_freq.Rds") # Letter freq in Wordle words
...
trial_words <- c("heart","haste","stare","stone",
                 "earth","tenor","irate","hater")
